...
// estrutura utilizada para guardar a informação e os endereços das subárvores

struct NodeType
{
    Aluno aluno;
    int fatorB; // fator de balanceamento da árvore
    NodeType* esquerda;
    NodeType* direita;
};
...
NodeType* root; //RAIZ DA ARVORE BINARIA
};
